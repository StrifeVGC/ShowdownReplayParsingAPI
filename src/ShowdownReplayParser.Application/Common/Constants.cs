namespace ShowdownReplayParser.Application.Common
{
    ...
    {
        public const string PLAYERONEPOKEMON = "|poke|p1|";
        public const string PLAYERTWOPOKEMON = "|poke|p2|";

        public const string PLAYERONEFIRSTPOKEMON = "p1a:";
        public const string PLAYERONESECONDPOKEMON = "p1b:";
        public const string PLAYERTWOFIRSTPOKEMON = "p2a:";
        public const string PLAYERTWOSECONDPOKEMON = "p2b:";
